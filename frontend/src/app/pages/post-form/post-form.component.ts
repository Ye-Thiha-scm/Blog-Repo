...
export class PostFormComponent implements OnInit {
  ...
  constructor( public router: Router, private activatedRoute: ActivatedRoute, private postService: PostService) { 
    this.postForm = new FormGroup({
      title: new FormControl('', [Validators.required, Validators.maxLength(255)]),
      description: new FormControl('', [Validators.required]),
      content: new FormControl('', [Validators.required]),
      imgUrl: new FormControl('', [Validators.required, Validators.maxLength(255)]),
  ...
  ngOnInit(): void {
    ...
    if (this.router.url.indexOf('/update-post') !== -1 && paramId !== undefined) {
      ...
      if (this.data) {
          ...
          this.postForm.controls['content'].setValue(this.data.data.content);
          this.postForm.controls['imgUrl'].setValue(this.data.data.imgUrl);
  ...
  public onClear = () => {
    if(this.confirmView == true) {
      ...
      this.postForm.controls['content'].enable();
      this.postForm.controls['imgUrl'].enable();
  ...
  public createPost = () => {
    ...
    if (this.postForm.valid) {
      ...
      this.postForm.controls['content'].disable();
      this.postForm.controls['imgUrl'].disable();
